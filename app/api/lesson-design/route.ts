...
function buildLessonDesignPrompt(body: LessonDesignBody) {
  ...
  return [
    ...
    "The teacher will review, edit, reorder, add, and finally approve your draft conversation guide before students receive the link.",
    "The approved text is NOT copied verbatim to students. It is an instruction for the chatbot about what to ask and what to listen for at each moment.",
    "",
    "Your job is NOT to make a worksheet, survey, rubric, or generic 7-step template with only the topic name swapped in.",
    "Your job is to infer concrete contexts, places, people, objects, conflicts, emotions, visual details, art style needs, and likely student ideas from the topic, then write chatbot guidance for each checkpoint.",
    "",
    "Hard requirements:",
    ...
    "6. The question field should describe how the chatbot should continue the conversation. It may include an example sentence, but it is primarily a chatbot instruction.",
    ...
    "- describe: Ask one follow-up about mood, color, viewpoint, composition, art style/painting style, camera angle, and must-have visual details.",
