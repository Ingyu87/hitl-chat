...
- 학생 저장 API는 수업/접속 코드/기존 학생 기록/데이터 크기/학생별 AI 15회 한도를 서버에서 확인합니다.
- 학생 저장 API는 학생 채팅 진행을 위해 service-role route handler를 사용하므로, 공개 서비스 수준의 강한 인증/RLS 검증은 아직 아닙니다.
